...
class InertiaViewSpec extends Specification implements JsonViewTest {
    ...
    void "Test render a raw JSON view"() {
        ...
        def inertiaPage = new InertiaPage(component: 'HelloWorld', props: [name: 'Mattias'], url: '/helloworld', version: '1')

        when: "A json view is rendered"
        def result = render view: '/inertia/json', model: [inertiaPage: inertiaPage]
